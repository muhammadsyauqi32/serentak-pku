    ...
    <footer className="bg-[#1A0B0B] text-[#F7F1E8] border-t border-[#C5A059]/30 pt-16 pb-12 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-[#C5A059]/20">
          ...
          <div className="md:col-span-6 space-y-4">
            ...
            <div className="space-y-1 font-body text-xs sm:text-sm text-[#F7F1E8]/85">
              <p className="font-subheading font-bold text-[#C5A059] text-xs uppercase tracking-wider">Program Kerja:</p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 font-body text-xs text-[#F7F1E8]/70">
          <div>
            <p>© 2026 SERENTAK 5.0 X RBB 2026. Ormawa Eksekutif PKU.</p>
          </div>

          {/* Technical Developer Credit */}
          <div className="flex items-center gap-2 text-[11px] text-[#F7F1E8]/60 font-subheading">
            <span>Website developed by: <strong className="text-[#C5A059]/90 font-semibold">Biro Riset dan Teknologi</strong> — Ormawa Eksekutif PKU</span>
          </div>
        </div>
      </div>
    </footer>
